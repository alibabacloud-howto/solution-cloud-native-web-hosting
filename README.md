...
### Project URL
[https://github.com/alibabacloud-howto/solution-cloud-native-wordpress](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress)


### Architecture Overview
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/archi.png)

### Index
- Deployment
  - [Terraform](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#terraform)
- Run Demo
  - [Step 1: Install Apache HTTP Server and PHP on ECS](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-1-install-apache-http-server-and-php-on-ecs)
  - [Step 2: Install and configure Wordpress on ECS](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-2-install-and-configure-wordpress-on-ecs)
  - [Step 3: Configure Redis caching](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-3-configure-redis-caching)
  - [Step 4 (Optional): Make custom ECS image for auto scaling](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-4-optional-make-custom-ecs-image-for-auto-scaling)
  - [Step 5 (Optional): Setup Auto Scaling (ESS) for ECS auto scaling](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-5-optional-setup-auto-scaling-ess-for-ecs-auto-scaling)
  - [Step 6 (Optional): Simulate fluctuating traffic to trigger auto scaling](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress#step-6-optional-simulate-fluctuating-traffic-to-trigger-auto-scaling)
...
[https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/blob/main/deployment/terraform/main.tf](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/blob/main/deployment/terraform/main.tf)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step1_0_1.png)

- In the command line, under the same folder of the terraform script file main.tf, open "terraform.tfstate":

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step1_0_2.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step1_1.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step1_1_1.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step1_2.png)
...
| --- | --- |
| DB_NAME | The name of the ApsaraDB for PolarDB database that you created.  In this tutorial, we use "wpdb", which is predefined in resource "alicloud_polardb_database" within Terraform script [https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/blob/main/deployment/terraform/main.tf](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/blob/main/deployment/terraform/main.tf). |
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step2_1.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step2_2.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step2_3.png)

Then the following page shows, which means the installation is success.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step2_4.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step3_1.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step3_2.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step3_3.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step3_4.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step3_5.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step4_1.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step4_2.png)

- Wait until the image creation progress becomes 100%. 

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step4_3.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_1.png)

- Select "Create from Scratch" and click "Start Creation". 

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_2.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_3.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_4.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_5.png)

- Click "OK" to finish the creation of the scaling group.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_6.png)

- Click "Add Scaling Configuration".

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_7.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_8.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_9.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_10.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_11.png)

- Wait until the success message appears. Click "Enable Configuration" and "OK" to enable the scaling configuration.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_12.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_13.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_14.png)

- Click the "Instances", "Manually Added" tab and then click "Add Existing Instances".

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_15.png)

- Add the ECS that you installed WordPress previously.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_16.png)

- Follow the following steps to create 2 scaling rules (ADD and DROP).

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_17.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_18.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_19.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_20.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_21.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_22.png)

- Verify that the statuses of new scaling tasks are both **Normal**.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_23.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step5_24.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step6_1.png)

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step6_2.png)
...
![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step6_3.png)

- After for a while, verify the SLB instance is attached with 3 ECS instances.

![image.png](https://github.com/alibabacloud-howto/solution-cloud-native-wordpress/raw/main/images/step6_4.png)
